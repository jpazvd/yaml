...
\title[Reading and writing YAML configuration files in Stata]{Reading and writing YAML configuration files in Stata:\\
...
The author thanks ... . The views expressed in this article are those of the author and do not necessarily reflect the official position of UNICEF.
