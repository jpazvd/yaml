...
. do run_tests.do         // Full suite (23 tests)
...
As of v1.9.0, all 23 tests pass on Stata 17+ and Stata 18. Frame-dependent tests (REG-02, FEAT-08) require Stata~16+; they are automatically skipped on earlier versions with appropriate warnings.
