...
yaml read using "data/test_config.yaml", replace verbose
...
yaml read using "data/test_config.yaml", locals replace verbose
...
yaml read using "data/test_config.yaml", scalars replace verbose
...
yaml write using "data/test_output.yaml", scalars(project year) replace verbose

di as text ""
di as text "File written. Reading back:"
type "data/test_output.yaml"
...
* Read config first
yaml read using "data/test_config.yaml", replace

* Write to new file
yaml write using "data/test_output2.yaml", replace verbose

di as text ""
di as text "File written. Contents:"
type "data/test_output2.yaml"
...
if (`c(stata_version)' >= 16) {
    ...
    * Load YAML into a frame
    yaml read using "data/test_config.yaml", frame(cfg) verbose
    ...
    * Create a second test file
    ...
    file open myfile using "data/test_config2.yaml", write replace
    ...
    * Read it into another frame
    yaml read using "data/test_config2.yaml", frame(cfg2) verbose
    ...
    * Reload both
    yaml read using "data/test_config.yaml", frame(cfg)
    yaml read using "data/test_config2.yaml", frame(cfg2)
